	...
	describe("created instance of quiz", function () {
		...
		describe("individual question", function () {
			...
			it("should have options A, B, C and D in that order", function () {
				expect(question.answers.map((a) => a.letter)).to.have.ordered.members([
					"A",
					"B",
					"C",
					"D",
			...
			it("should have answers shuffled", function () {
				expect(question.answers.map((a) => a.answer)).to.have.members([
					"100",
					"200",
					"300",
					"400",
				...
				).to.not.have.ordered.members(["100", "200", "300", "400"]);
			});
			...
			it("should have correct answer indicated", function () {
				...
				expect(question.answers.find((a) => a.isCorrect).answer).to.equal(
					"100"
				);
			});
		});
